...
const TimerDashboard: React.FC<TimerDashboardProps> = ({ navComponent, scrambleComponent, timerTableComponent, cubeDisplayComponent }) => {
  return (
    <>
      <div className="custom-border absolute z-20 border-red-200 bg-red-300 lg:h-[13.5rem] lg:w-[14.3rem] max-lg:bottom-0 max-lg:left-0 max-lg:right-0 max-lg:top-auto max-lg:h-[11.8vw] max-lg:w-auto max-lg:text-[2.5vw]">
        {navComponent}
      </div>
      <div className="custom-border absolute left-[14.3rem] right-0 top-0 z-20 border-orange-200 bg-orange-300 text-center md:text-4xl max-lg:left-0">
        {scrambleComponent}
      </div>
