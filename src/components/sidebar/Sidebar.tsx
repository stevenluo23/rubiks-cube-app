...
const Sidebar: React.FC<SidebarProps> = ({ navComponent, timerTableComponent }) => {
  return (
    <>
      <nav className="custom-border absolute z-20 border-red-200 bg-red-300 max-lg:bottom-0 max-lg:left-0 max-lg:right-0 max-lg:top-auto max-lg:h-[11.8vw] max-lg:w-auto max-lg:text-[2.5vw] lg:h-[13.5rem] lg:w-[14.3rem]">
        {navComponent}
      </nav>
