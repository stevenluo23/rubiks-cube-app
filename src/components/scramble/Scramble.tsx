...
import { applyScramble, generateScramble, Cube, DisplayCube } from "react-rubiks-cube-utils";
  ...
  return (
    <>
      <header className="flex justify-center items-center gap-8 bg-orange-300 h-fit sm:h-[10svh]">
        ...
        {!isLoading && !errorMsg && <span className="text-xl sm:text-2xl content-center h-full w-fit pl-2 py-2">{scramble}</span>}
